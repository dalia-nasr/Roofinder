...
def panel_rotation(filename, solar_roof_area, new_image, high_reso_orig, nm):
    ...
    return 'static/panels/'+nm


def draw_panels_area(fname, nm):
        ...
        location = panel_rotation(fname, solar_roof, new_image, high_reso_orig, nm)
        return area_roof, location